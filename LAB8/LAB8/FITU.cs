...
namespace LAB8
{
    class FITU : Student, IGroupOperations
    {
        ...
        public delegate decimal Max(FITU students, int size);
        public event Max Maximum;
        public delegate decimal Minimum1(FITU students, int size);
        ...
        public override void Print()
        {
            ...
            Console.WriteLine("Воостановившийся : " + recover);
